...
export default function SignUpPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Step 1: Register with Neon Auth
    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-pink-400 via-fuchsia-400 to-rose-400 px-4 py-8">
      <div className="bg-white/20 backdrop-blur-md rounded-3xl p-8 shadow-2xl w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <p className="text-white/80 mt-1">Buat karakter pigmu!</p>
        </div>
        ...
        <p className="text-center text-white/80 mt-5 text-sm">
          Sudah punya akun?{" "}
          <Link href="/auth/sign-in" className="text-white font-bold underline">
            Masuk
          </Link>
        </p>
      </div>
